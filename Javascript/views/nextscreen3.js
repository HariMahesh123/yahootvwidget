...
var Sub402View = new KONtx.Class({
	ClassName: 'Sub402View',
...
//code the define the next button
			...
			events: {	
					...
					KONtx.application.loadView('view-Sub401', { pass_number: tempo1 , pass_title: (prev_title[tempo1].name) , pass_description: (prev_description[tempo1].name) , pass_image: (prev_image[tempo1].name) , pass_video: (prev_video[tempo1].name) , pass_director: (prev_director[tempo1].name) , pass_releasedate: (prev_releasedate[tempo1].name) , pass_duration: (prev_duration[tempo1].name) , pass_actor1: (prev_actor1[tempo1].name) , pass_actor2: (prev_actor2[tempo1].name) , pass_actor3: (prev_actor3[tempo1].name)});
